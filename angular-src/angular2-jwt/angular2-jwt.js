...
require("rxjs/operators").fromPromise;
require("rxjs/operators").defer;
require("rxjs/operators").mergeMap;
    ...
    AuthHttp.prototype.request = function (url, options) {
        ...
        return Observable_1.Observable.defer(function () {
            ...
            if (token instanceof Promise) {
                return Observable_1.Observable.pipe(fromPromise(token).mergeMap(function (jwtToken) { return _this.requestWithToken(req, jwtToken); }));
            }
            else {
